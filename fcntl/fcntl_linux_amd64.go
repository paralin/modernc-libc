...
const (
	AT_EACCESS            = 0x200      // fcntl-linux.h:389:1:
	AT_FDCWD              = -100       // fcntl-linux.h:372:1:
	AT_REMOVEDIR          = 0x200      // fcntl-linux.h:376:1:
	AT_SYMLINK_FOLLOW     = 0x400      // fcntl-linux.h:378:1:
	AT_SYMLINK_NOFOLLOW   = 0x100      // fcntl-linux.h:375:1:
	FAPPEND               = 1024       // fcntl-linux.h:305:1:
	FASYNC                = 8192       // fcntl-linux.h:307:1:
	FD_CLOEXEC            = 1          // fcntl-linux.h:219:1:
	FFSYNC                = 1052672    // fcntl-linux.h:306:1:
	FNDELAY               = 2048       // fcntl-linux.h:309:1:
	FNONBLOCK             = 2048       // fcntl-linux.h:308:1:
	...
	F_TEST                = 3          // fcntl.h:253:1:
	F_TLOCK               = 2          // fcntl.h:252:1:
	F_ULOCK               = 0          // fcntl.h:250:1:
	...
	POSIX_FADV_DONTNEED   = 4          // fcntl-linux.h:322:1:
	POSIX_FADV_NOREUSE    = 5          // fcntl-linux.h:323:1:
	POSIX_FADV_NORMAL     = 0          // fcntl-linux.h:318:1:
	POSIX_FADV_RANDOM     = 1          // fcntl-linux.h:319:1:
	POSIX_FADV_SEQUENTIAL = 2          // fcntl-linux.h:320:1:
	POSIX_FADV_WILLNEED   = 3          // fcntl-linux.h:321:1:
	...
	X_STATBUF_ST_BLKSIZE  = 0          // struct_stat.h:160:1:
	X_STATBUF_ST_NSEC     = 0          // struct_stat.h:163:1:
	X_STATBUF_ST_RDEV     = 0          // struct_stat.h:161:1:
